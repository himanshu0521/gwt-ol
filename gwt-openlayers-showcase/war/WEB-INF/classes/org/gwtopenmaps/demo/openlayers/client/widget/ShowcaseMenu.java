...
import org.gwtopenmaps.demo.openlayers.client.examples.vector.ComparisonFilterExample;
...
public class ShowcaseMenu extends FlexTable {
	...
	ShowcaseMenuItem filterWFSitem = new ShowcaseMenuItem(
			"Comparison Filter Example",
			"Only display the 'road' features.", new ClickHandler() {
				public void onClick(ClickEvent evt) {
					ComparisonFilterExample filterWfsExample = new ComparisonFilterExample();
					contentPanel.setExample(filterWfsExample.getMapExample());
					contentPanel.setExampleDescription("Filtering WFS Results By Comparison");
					contentPanel.setExampleSource("Source here");
					contentPanel.selectTab(0);
				}
			});
